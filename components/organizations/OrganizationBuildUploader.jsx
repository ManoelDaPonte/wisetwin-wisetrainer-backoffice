// components/organizations/OrganizationBuildUploader.jsx
"use client";
...
export default function OrganizationBuildUploader({
	organizationId,
	containerName,
	onClose,
	onSuccess,
	...
	// components/organizations/OrganizationBuildUploader.jsx (suite)
	const handleDrop = (e) => {
		e.preventDefault();
		e.stopPropagation();
	...
	const handleSubmit = async (e) => {
		...
		reader.onload = async () => {
			try {
				...
				formDataToSend.append("container", containerName);
				...
				const response = await fetch(
					"/api/organizations/builds/upload",
					{
						method: "POST",
						body: formDataToSend,
					}
						...
						<div className="space-y-3">
							...
							<div>
								<Label htmlFor="containerName">
									Container Azure (non modifiable)
								</Label>
								<Input
									id="containerName"
									value={containerName}
								...
								<p className="text-xs text-muted-foreground mt-1">
									Le conteneur spécifique à cette organisation
								</p>
							</div>
						</div>
